        ...
        <Toolbar className={classes.root} id="back-to-top-anchor">
          {isMenuOpen ? (
            <IconButton
              ...
              edge="start"
              className={classNames(classes.transition, classes.menuButton)}
              color="inherit"
            >
          ...
          >
            ...
            >
              <Button
                ...
                className={(classes.transition, classes.marginRightFour)}
              >
                <Typography
                  variant="body1"
                  className={classNames(classes.whiteText, classes.letterSpace)}
                >
                  Products
                </Typography>
              </Button>
              ...
              {user ? (
                <div className={classes.btnContainer}>
                  <Button
                    ...
                    className={classNames(classes.whiteText, classes.hideMini)}
                  >
                    <PaymentIcon />
                    <Typography
                      variant="body1"
                ...
                <div className={classes.btnContainer}>
                  ...
                  <Button
                    ...
                    className={classNames(classes.transition, classes.hideMini)}
                  >
